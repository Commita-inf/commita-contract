...
const InputFieldComponent = ({
  ...
  <div className="flex flex-col items-start justify-start mb-2 md:mb-0 w-full">
    <label className="text-lg font-bold text-gray-400 w-28" htmlFor={type}>
      {lableText}
    </label>
    <input
...
const ContractForm = () => {
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.section}>
          <Image
            style={styles.logo}
            src="https://commita.info/images/commita-logo-no-bg-with-text-image.png"
          />
          <Text style={styles.name}>{name}</Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.subname}>Contrat d'Abonnement</Text>
        </View>
        <View style={styles.section}>
        ...
        <View style={styles.section}>
          <Text style={styles.header}> 1. Objet du contrat</Text>
          <Text style={styles.text}>
        ...
        <View style={styles.section}>
          <Text style={styles.header}> 2. Durée de l'abonnement</Text>
          <Text style={styles.text}>
  ...
  return (
    <form
      className="flex flex-col items-center w-screen h-screen gap-8 p-8"
    ...
    >
      ...
      {/*       <div className="w-full h-full flex-1">
        ...
        <textarea
          className={`bg-transparent w-full h-full bg-white rounded-lg px-3 py-2 text-sm text-gray-400 border ${
            errors.tenderDescription && "border-red-500"
          } rounded-lg appearance-none focus:outline-none focus:shadow-outline focus:border-amber-500`}
          id="message"
      ...
      <div className="flex items-center justify-center w-full gap-4 mt-8">
        <button className="inline-flex items-center justify-center w-32 h-12 text-sm font-medium text-center text-white border border-amber-500 rounded-xl hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-amber-600 dark:hover:bg-amber-700 dark:focus:ring-amber-800 shadow-md shadow-gray-400">
          <span className="text-lg w-full text-amber-500">Annuler</span>
        </button>
        <button
          type="submit"
          className="inline-flex items-center justify-center w-32 h-12 text-sm font-medium text-center text-white bg-amber-500 rounded-xl hover:bg-amber-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-amber-600 dark:hover:bg-amber-700 dark:focus:ring-amber-800 shadow-md shadow-gray-400"
        >
          Download
        </button>
      </div>
